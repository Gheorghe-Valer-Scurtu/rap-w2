class zcl_w2_data_gen_ac definition
  public
  final
  create public .
...
class zcl_w2_data_gen_ac implementation.

  method if_oo_adt_classrun~main.

    data: lt_acc_categ type table of zw2_acc_categ,
          lt_catego    type table of zw2_categ,
          lt_clientes  type table of zw2_clientes,
          lt_clnts_lib type table of zw2_clnt_lib,
...
******** zw2_acc_categ ********
    ...
    delete from zw2_acc_categ.
    insert zw2_acc_categ from table @lt_acc_categ.
...
******** zw2_categ ********
    ...
    "Delete possible entries; insert new entries
    delete from zw2_categ.
    insert zw2_categ from table @lt_catego.
...
******** zw2_clientes ********
    ...
    "Delete possible entries; insert new entries
    delete from zw2_clientes.
    insert zw2_clientes from table @lt_clientes.
...
******** zw2_clnt_lib
    ...
    "Delete possible entries; insert new entries
    delete from zw2_clnt_lib.
    insert zw2_clnt_lib from table @lt_clnts_lib.
...
******** zw2_libros ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from zw2_libros.
    insert zw2_libros from table @lt_libros.
